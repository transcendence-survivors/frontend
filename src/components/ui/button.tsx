...
const buttonVariants = cva(
	"cursor-pointer  group/button inline-flex shrink-0 items-center justify-center \
    rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all \
		...
		variants: {
			variant: {
				...
				secondary:
                    ...
                    focus-visible:bg-[color-mix(in_oklch,var(--secondary),var(--foreground)_5%)] \
